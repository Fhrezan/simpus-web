...
// Firebase v8 (CDN style, untuk GitHub Pages)
...
// Tangkap pendaftaran dan simpan ke Firebase
  ...
  document.body.addEventListener("submit", function (e) {
    if (e.target && e.target.id === "form-pendaftaran") {
      ...
      db.collection("patients").add(data)
        .then(() => {
          feedback.textContent += " ✅ Tersimpan ke Firebase.";
          feedback.style.color = "green";
        })
        .catch((error) => {
          console.error("❌ Gagal:", error);
          feedback.textContent += " ⚠️ Gagal simpan ke Firebase.";
