...
// Event listener untuk simpan data ke Firebase
document.addEventListener("DOMContentLoaded", () => {
  document.body.addEventListener("submit", async (e) => {
    if (e.target && e.target.id === "form-pendaftaran") {
      ...
      if (!name || !dob || !gender || !visitType) return;
      ...
      try {
        ...
        feedback.textContent += " ✅ Data juga berhasil disimpan ke Firebase.";
        feedback.style.color = "green";
      } catch (error) {
        console.error("❌ Gagal simpan ke Firebase:", error);
        feedback.textContent += " ⚠️ Gagal menyimpan ke Firebase.";
